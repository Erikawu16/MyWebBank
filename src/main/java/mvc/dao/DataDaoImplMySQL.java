...
public class DataDaoImplMySQL implements DataDao {
	...
	public Optional<SexData> getSexDataById(Integer id) {
		return Optional
				.of(jdbcTemplate.queryForObject(sqlSingle, new BeanPropertyRowMapper<>(SexData.class), "Sex", id));
	}
	...
	public Optional<TypeData> getTypeDataById(Integer id) {
		return Optional
				.of(jdbcTemplate.queryForObject(sqlSingle, new BeanPropertyRowMapper<>(TypeData.class), "Type", id));
	}
	...
	public Optional<StatusData> getStatusDataById(Integer id) {
		return Optional.of(
				jdbcTemplate.queryForObject(sqlSingle, new BeanPropertyRowMapper<>(StatusData.class), "Status", id));
	...
	public void updateCurrency() {
		try {
			...
			// 找到匯率表格
			Element table = doc.select("table.table.table-striped.table-bordered.table-condensed.table-hover tbody")
					.first();
